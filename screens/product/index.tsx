    ...
    <ScrollView style={style.container}>
      ...
      <View style={{ marginHorizontal: "5%", paddingBottom: "15%" }}>
        ...
        >
          ...
          fashionable twist to your everyday look. The rugged yet refined denim
          material adds a touch of urban flair, allowing you to effortlessly
          elevate your style. Designed for both comfort and durability, these
          shoes feature a cushioned insole that provides all-day support,
          ensuring a comfortable stride from morning to night. The sturdy rubber
          outsole offers excellent traction on various surfaces, making them
        ...
        <Button
          ...
          title="Add to cart"
          IconBefore={<AntDesign name="shoppingcart" size={24} color="white" />}
        />
      </View>
    </ScrollView>
  );
